    ...
    try:
        ...
        while True:
            ...
            for target_item in target_items:
                ...
                # --------------------------------------------------------------
                # 'CCI' : 2일전 < 30미만, 3일전 > 2일전, 1일전 > 2일전, 현재 > 1일전
                # indicators_data[0][0]['CCI'] : 현재
                # indicators_data[0][1]['CCI'] : 1일전
                # indicators_data[0][2]['CCI'] : 2일전
                # indicators_data[0][3]['CCI'] : 3일전
                # --------------------------------------------------------------
                if (Decimal(str(indicators_data[6][0]['CCI'])) > Decimal(str(indicators_data[6][1]['CCI']))
                        and Decimal(str(indicators_data[6][1]['CCI'])) > Decimal(str(indicators_data[6][2]['CCI']))
                        ...
                        and Decimal(str(-100)) < Decimal(str(indicators_data[6][0]['CCI'])) < Decimal(str(-85))):
                        cci_val = True
