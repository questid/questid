...
# Keys
access_key = 'fVt0PAGNqRyaupZZxtdqZz4RwgJx7ZJoa8NgnnvS'
secret_key = '8JoynKTM00vOMdfw8ZU4TMrX9QICAGSYuvCJfKDV'
...
def get_cci(candle_data, loop_cnt):
    try:
        ...
        ordered_df['SMA'] = ordered_df['TP'].rolling(window=14).mean()
        ordered_df['MAD'] = ordered_df['TP'].rolling(window=14).apply(lambda x: pd.Series(x).mad())
