            ...
            for target_item in target_items:
                for ticker in tickers:
                    if target_item['market'] == ticker['market']:
                        ...
                        #         and Decimal(str(indicators_data[0][1]['RSI'])) < Decimal(
                        #             str(indicators_data[0][2]['RSI']))
                        #         and Decimal(str(indicators_data[0][3]['RSI'])) < Decimal(
                        #             str(indicators_data[0][2]['RSI']))
                        ...
                        #         and Decimal(str(indicators_data[1][1]['MFI'])) < Decimal(
                        #             str(indicators_data[1][2]['MFI']))
                        #         and Decimal(str(indicators_data[1][3]['MFI'])) < Decimal(
                        #             str(indicators_data[1][2]['MFI']))
                        ...
                        #         and Decimal(str(indicators_data[2][1]['OCL'])) < Decimal(
                        #             str(indicators_data[2][2]['OCL']))
                        #         and Decimal(str(indicators_data[2][3]['OCL'])) < Decimal(
                        #             str(indicators_data[2][2]['OCL']))
                        ...
                        # if (Decimal(str(indicators_data[4][0]['W'])) < Decimal(str(indicators_data[4][1]['W']))
                        #         and Decimal(str(indicators_data[4][2]['W'])) < Decimal(
                        #             str(indicators_data[4][1]['W']))
                        #         and Decimal(str(indicators_data[4][3]['W'])) > Decimal(
                        #             str(indicators_data[4][2]['W']))
                        #         and Decimal(str(indicators_data[4][3]['W'])) > Decimal(
                        #             str(indicators_data[4][1]['W']))
                        #         and Decimal(str(indicators_data[4][3]['W'])) > Decimal(str(-20))
                        #         and Decimal(str(-20)) > Decimal(str(indicators_data[4][0]['W'])) > Decimal(str(-30))):
                        #     williams_val = True

                        if (Decimal(str(indicators_data[6][0]['CCI'])) < Decimal(str(indicators_data[6][1]['CCI']))
                                # and Decimal(str(indicators_data[6][1]['CCI'])) > Decimal(
                                #     str(indicators_data[6][2]['CCI']))
                                # and Decimal(str(indicators_data[6][3]['CCI'])) > Decimal(str(indicators_data[6][2]['CCI']))
                                and Decimal(str(indicators_data[6][1]['CCI'])) > Decimal(str(100))
                                and Decimal(str(90)) < Decimal(str(indicators_data[6][0]['CCI'])) < Decimal(
                                    str(100))):
                            cci_val = True
