            ...
            for target_item in target_items:
                for ticker in tickers:
                    if target_item['market'] == ticker['market']:
                        ...
                        # --------------------------------------------------------------
                        indicators_data = upbit.get_indicators(target_item['market'], '240', 200, 5)
                        ...
                        if (Decimal(str(indicators_data[6][0]['CCI'])) < Decimal(str(indicators_data[6][1]['CCI']))
                                # and Decimal(str(indicators_data[6][2]['CCI'])) < Decimal(
                                #     str(indicators_data[6][1]['CCI']))
                                # and Decimal(str(indicators_data[4][3]['CCI'])) > Decimal(
                                #     str(indicators_data[6][2]['CCI']))
                                # and Decimal(str(indicators_data[4][3]['CCI'])) > Decimal(
                                #     str(indicators_data[4][1]['CCI']))
                                and Decimal(str(indicators_data[6][1]['CCI'])) > Decimal(str(100))
                                and Decimal(str(indicators_data[6][0]['CCI'])) < Decimal(str(100)) :
